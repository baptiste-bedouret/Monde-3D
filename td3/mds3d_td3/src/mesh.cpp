...
void Mesh::draw(const Shader &shd)
{
  ...
  // Activate the VBO of the current mesh: //active les buffers
  glBindVertexArray(mVertexArrayId);
  glBindBuffer(GL_ARRAY_BUFFER, mVertexBufferId); // GL_ARRAY_BUFFER liste des attributs des sommets
  glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, mIndexBufferId);

  // Specify vertex data

  // 1er vertex = x0,y0,z0,ny0,nz0,r0,g0,b0,a0,u0,v0
